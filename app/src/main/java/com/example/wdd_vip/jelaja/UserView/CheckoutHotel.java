...
public class CheckoutHotel extends AppCompatActivity {
    ...
    TextView t_saldo;
    @BindView(R.id.t_night)
    TextView t_night;
    @BindView(R.id.t_room)
    TextView t_room;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_checkout_hotel);
        ...
        b_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(price>saldo)
                {
                    AlertDialog.Builder builder = new AlertDialog.Builder(CheckoutHotel.this);
                    ...
                    builder.setNegativeButton("Batal", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            startActivity(new Intent(CheckoutHotel.this,JelaPay.class));
                        }
                    });
                    builder.show();
                }
                else
                {
                    ...
                    api.bookHotel(userid, getIntent().getIntExtra("id_schedule", 0), getIntent().getIntExtra("passenger",0), getIntent().getIntExtra("night",0), getIntent().getIntExtra("room",0), price)
    ...
    public void setMyTextView(int userid)
    {
        ...
        t_phone.setText(getIntent().getStringExtra("phone"));
        t_room.setText(String.valueOf(getIntent().getIntExtra("room",0)));
        t_night.setText(String.valueOf(getIntent().getIntExtra("night",0)));
