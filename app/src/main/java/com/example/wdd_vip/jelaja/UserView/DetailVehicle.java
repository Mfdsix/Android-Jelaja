    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DetailVehicle.this, CheckoutVehicle.class);
    ...
    protected void getDetailSchedule(int schedule_id) {
        ...
        apiService.getDetailSchedule(schedule_id).enqueue(new Callback<AuthModel>() {
            ...
            public void onResponse(Call<AuthModel> call, Response<AuthModel> response) {
                ...
                {
                    String full_url = BASE_URL+"upload/provider/"+response.body().getPhoto();
                    ...
                    Glide.with(DetailVehicle.this).load(full_url).override(swidth,400).centerCrop().diskCacheStrategy(DiskCacheStrategy.ALL)
                            .into(photo);
                }
            }
