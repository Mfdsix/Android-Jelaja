...
public class AddHotelSchedule extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_hotel_schedule);
        ...
        e_s_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(AddHotelSchedule.this, datePicker, calendar.get(Calendar.YEAR)
        ...
        e_s_hour.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                timePickerDialog = new TimePickerDialog(AddHotelSchedule.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                apiServices.addSchedule(userid, "", "",e_s_date.getText().toString()+" "+e_s_hour.getText().toString(), "", e_s_price.getText().toString()).enqueue(new Callback<AuthModel>() {
                    @Override
                    public void onResponse(Call<AuthModel> call, Response<AuthModel> response) {
                        AuthModel userData = response.body();
                        if (response.isSuccessful()) {
                            Snackbar.make(v, "Penambahan Jadwal Sukses", Snackbar.LENGTH_SHORT).show();
                            Handler handler = new Handler();
                            handler.postDelayed(new Runnable() {
                                @Override
                                public void run() {
                                    startActivity(new Intent(AddHotelSchedule.this, ScheduleProvier.class));
                                }
                            },2000);
                        }
                        else
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId())
        {
            case android.R.id.home :
                startActivity(new Intent(AddHotelSchedule.this, ProviderActivity.class));
                return true;
            default:
